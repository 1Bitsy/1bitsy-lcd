...
typedef agg::pixfmt_rgb565_gamma<gamma_lut_type>            pixfmt_type;
...
public:
    ...
    void on_idle(void)
    {
        if (m_gamma.gamma() >= 3.1999)
            m_gamma.gamma(0.4);
        else
            m_gamma.gamma(m_gamma.gamma() * 2);
    }
